  ...
  public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
    ...
    holder.rootView.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        if (!isDisabled) {
          v.setBackground(timelineView.getResources().getDrawable(timelineView.getSelectedBackground()));
          holder.dateView.setTextColor(timelineView.getSelectedTextColor());
          holder.dayView.setTextColor(timelineView.getSelectedTextColor());
          holder.monthView.setTextColor(timelineView.getSelectedTextColor());
  ...
  class ViewHolder extends RecyclerView.ViewHolder {
    ...
    boolean bind(int month, int day, int dayOfWeek, int year, int position) {
      ...
      if (selectedPosition == position) {
        rootView.setBackground(timelineView.getResources().getDrawable(timelineView.getSelectedBackground()));
